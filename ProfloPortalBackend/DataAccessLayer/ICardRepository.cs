...
namespace ProfloPortalBackend.DataAccessLayer
{
    public interface ICardRepository
    {
        ...
        bool UpdateCard(string cardId, Card card);
        ...
        void CreateInvite(string cardID, Invitee invite);
        bool RemoveInvite(string cardId, string inviteID);
       // bool UpdateInvite(string cardId, string inviteID, Invitee invite);
        ICollection<Invitee> GetCardInvites(string cardID);
        #endregion
